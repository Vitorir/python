...
#faça um programa que imprima os valores de todas as chaves, uma por #uma, e no final remova a chave "Genero" 
# e caso ela não exista, mostre #uma mensagem de erro informando que a chave não existe

filme = {"Titulo" : "It a Coisa", "Genero": "Terror", "Duracao": 120, "Cartaz": False}
for chave in filme.keys():
    print(chave)

print(filme.pop('ola', 'Não existe genero em filme'))
...
jogo2 = jogo.copy()
jogo2['Título'] = 'Perfect World'
jogo2['Gênero'] = 'MMORPG'
jogo2['Lancamento'] = 2005
print(jogo2)